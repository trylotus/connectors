...
type OwnershipTransferred struct {
	...
	BlockNumber   uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash        []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	PreviousOwner []byte                 `protobuf:"bytes,4,opt,name=previousOwner,proto3" json:"previousOwner,omitempty"`
	NewOwner      []byte                 `protobuf:"bytes,5,opt,name=newOwner,proto3" json:"newOwner,omitempty"`
}
...
type ParametersUpdated struct {
	...
	BlockNumber  uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash       []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	BaseToken    []byte                 `protobuf:"bytes,4,opt,name=baseToken,proto3" json:"baseToken,omitempty"`
	NewThreshold []byte                 `protobuf:"bytes,5,opt,name=newThreshold,proto3" json:"newThreshold,omitempty"` // uint256
	NewR         []byte                 `protobuf:"bytes,6,opt,name=newR,proto3" json:"newR,omitempty"`                 // uint256
}
...
type FeeManagerUpdated struct {
	...
	BlockNumber   uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash        []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	NewFeeManager []byte                 `protobuf:"bytes,4,opt,name=newFeeManager,proto3" json:"newFeeManager,omitempty"`
}
...
type RewardManagerUpdated struct {
	...
	BlockNumber      uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash           []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	NewRewardManager []byte                 `protobuf:"bytes,4,opt,name=newRewardManager,proto3" json:"newRewardManager,omitempty"`
}
...
type WooGuardianUpdated struct {
	...
	BlockNumber    uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash         []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	NewWooGuardian []byte                 `protobuf:"bytes,4,opt,name=newWooGuardian,proto3" json:"newWooGuardian,omitempty"`
}
...
type WooSwap struct {
	...
	BlockNumber uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash      []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	FromToken   []byte                 `protobuf:"bytes,4,opt,name=fromToken,proto3" json:"fromToken,omitempty"`
	ToToken     []byte                 `protobuf:"bytes,5,opt,name=toToken,proto3" json:"toToken,omitempty"`
	FromAmount  []byte                 `protobuf:"bytes,6,opt,name=fromAmount,proto3" json:"fromAmount,omitempty"` // uint256
	ToAmount    []byte                 `protobuf:"bytes,7,opt,name=toAmount,proto3" json:"toAmount,omitempty"`     // uint256
	...
	RebateTo    []byte                 `protobuf:"bytes,10,opt,name=rebateTo,proto3" json:"rebateTo,omitempty"`
}
...
type WooracleUpdated struct {
	...
	BlockNumber uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash      []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	NewWooracle []byte                 `protobuf:"bytes,4,opt,name=newWooracle,proto3" json:"newWooracle,omitempty"`
}
...
type StrategistUpdated struct {
	...
	BlockNumber uint64                 `protobuf:"varint,2,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	TxHash      []byte                 `protobuf:"bytes,3,opt,name=txHash,proto3" json:"txHash,omitempty"`
	Strategist  []byte                 `protobuf:"bytes,4,opt,name=strategist,proto3" json:"strategist,omitempty"`
...
var file_WOOPP_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x75, 0x73, 0x65, 0x64,
	...
	0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x22, 0xbe, 0x01, 0x0a, 0x14, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x12, 0x2a, 0x0a, 0x02, 0x74, 0x73, 0x18,
	...
	0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73,
	0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12,
	0x24, 0x0a, 0x0d, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x4f, 0x77, 0x6e, 0x65, 0x72,
	...
	0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65,
	0x72, 0x22, 0xcf, 0x01, 0x0a, 0x11, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	...
	0x09, 0x62, 0x61, 0x73, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x09, 0x62, 0x61, 0x73, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x22, 0x0a, 0x0c, 0x6e,
	0x65, 0x77, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x0c, 0x6e, 0x65, 0x77, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x12,
	0x12, 0x0a, 0x04, 0x6e, 0x65, 0x77, 0x52, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x6e,
	0x65, 0x77, 0x52, 0x22, 0x9f, 0x01, 0x0a, 0x11, 0x46, 0x65, 0x65, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73,
	0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12,
	0x24, 0x0a, 0x0d, 0x6e, 0x65, 0x77, 0x46, 0x65, 0x65, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x6e, 0x65, 0x77, 0x46, 0x65, 0x65, 0x4d, 0x61,
	0x6e, 0x61, 0x67, 0x65, 0x72, 0x22, 0xa8, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	...
	0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06,
	0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x74, 0x78,
	0x48, 0x61, 0x73, 0x68, 0x12, 0x2a, 0x0a, 0x10, 0x6e, 0x65, 0x77, 0x52, 0x65, 0x77, 0x61, 0x72,
	0x64, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x10,
	0x6e, 0x65, 0x77, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	0x22, 0x8a, 0x01, 0x0a, 0x08, 0x55, 0x6e, 0x70, 0x61, 0x75, 0x73, 0x65, 0x64, 0x12, 0x2a, 0x0a,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa2, 0x01,
	...
	,
	...
	,
	...
	0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x24, 0x0a, 0x0d,
	0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x0d, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x4f, 0x77, 0x6e,
	0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x6e, 0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x22, 0x99,
	0x01, 0x0a, 0x0f, 0x57, 0x6f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	,
