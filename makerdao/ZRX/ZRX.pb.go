...
func (x *Approval) Reset() {
	*x = Approval{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ZRX_ZRX_proto_msgTypes[0]
...
func (*Approval) Descriptor() ([]byte, []int) {
	return file_ZRX_ZRX_proto_rawDescGZIP(), []int{0}
}
...
func (x *Transfer) Reset() {
	*x = Transfer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ZRX_ZRX_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Transfer) Descriptor() ([]byte, []int) {
	return file_ZRX_ZRX_proto_rawDescGZIP(), []int{1}
}
...
var file_ZRX_ZRX_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x5a, 0x52, 0x58, 0x2f, 0x5a, 0x52, 0x58, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x03, 0x5a, 0x52, 0x58, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x36, 0x5a, 0x34, 0x62, 0x6c, 0x65, 0x70, 0x2e, 0x61, 0x69,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x2f, 0x5a, 0x52, 0x58, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_ZRX_ZRX_proto_rawDescOnce sync.Once
	file_ZRX_ZRX_proto_rawDescData = file_ZRX_ZRX_proto_rawDesc
)

func file_ZRX_ZRX_proto_rawDescGZIP() []byte {
	file_ZRX_ZRX_proto_rawDescOnce.Do(func() {
		file_ZRX_ZRX_proto_rawDescData = protoimpl.X.CompressGZIP(file_ZRX_ZRX_proto_rawDescData)
	})
	return file_ZRX_ZRX_proto_rawDescData
}

var file_ZRX_ZRX_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ZRX_ZRX_proto_goTypes = []interface{}{
	(*Approval)(nil),              // 0: ZRX.Approval
	(*Transfer)(nil),              // 1: ZRX.Transfer
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_ZRX_ZRX_proto_depIdxs = []int32{
...
func init() { file_ZRX_ZRX_proto_init() }
func file_ZRX_ZRX_proto_init() {
	if File_ZRX_ZRX_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ZRX_ZRX_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ZRX_ZRX_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ZRX_ZRX_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ZRX_ZRX_proto_goTypes,
		DependencyIndexes: file_ZRX_ZRX_proto_depIdxs,
		MessageInfos:      file_ZRX_ZRX_proto_msgTypes,
	}.Build()
	File_ZRX_ZRX_proto = out.File
	file_ZRX_ZRX_proto_rawDesc = nil
	file_ZRX_ZRX_proto_goTypes = nil
	file_ZRX_ZRX_proto_depIdxs = nil
}
