...
func (x *Approval) Reset() {
	*x = Approval{}
	if protoimpl.UnsafeEnabled {
		mi := &file_YFi_YFi_proto_msgTypes[0]
...
func (*Approval) Descriptor() ([]byte, []int) {
	return file_YFi_YFi_proto_rawDescGZIP(), []int{0}
}
...
func (x *Transfer) Reset() {
	*x = Transfer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_YFi_YFi_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Transfer) Descriptor() ([]byte, []int) {
	return file_YFi_YFi_proto_rawDescGZIP(), []int{1}
}
...
var file_YFi_YFi_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x59, 0x46, 0x69, 0x2f, 0x59, 0x46, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x03, 0x59, 0x46, 0x69, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x2f, 0x59, 0x46, 0x69, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_YFi_YFi_proto_rawDescOnce sync.Once
	file_YFi_YFi_proto_rawDescData = file_YFi_YFi_proto_rawDesc
)

func file_YFi_YFi_proto_rawDescGZIP() []byte {
	file_YFi_YFi_proto_rawDescOnce.Do(func() {
		file_YFi_YFi_proto_rawDescData = protoimpl.X.CompressGZIP(file_YFi_YFi_proto_rawDescData)
	})
	return file_YFi_YFi_proto_rawDescData
}

var file_YFi_YFi_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_YFi_YFi_proto_goTypes = []interface{}{
	(*Approval)(nil),              // 0: YFi.Approval
	(*Transfer)(nil),              // 1: YFi.Transfer
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_YFi_YFi_proto_depIdxs = []int32{
...
func init() { file_YFi_YFi_proto_init() }
func file_YFi_YFi_proto_init() {
	if File_YFi_YFi_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_YFi_YFi_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_YFi_YFi_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_YFi_YFi_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_YFi_YFi_proto_goTypes,
		DependencyIndexes: file_YFi_YFi_proto_depIdxs,
		MessageInfos:      file_YFi_YFi_proto_msgTypes,
	}.Build()
	File_YFi_YFi_proto = out.File
	file_YFi_YFi_proto_rawDesc = nil
	file_YFi_YFi_proto_goTypes = nil
	file_YFi_YFi_proto_depIdxs = nil
}
