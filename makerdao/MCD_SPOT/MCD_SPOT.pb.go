...
func (x *LogNote) Reset() {
	*x = LogNote{}
	if protoimpl.UnsafeEnabled {
		mi := &file_MCD_SPOT_proto_msgTypes[0]
...
func (*LogNote) Descriptor() ([]byte, []int) {
	return file_MCD_SPOT_proto_rawDescGZIP(), []int{0}
}
...
func (x *Poke) Reset() {
	*x = Poke{}
	if protoimpl.UnsafeEnabled {
		mi := &file_MCD_SPOT_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Poke) Descriptor() ([]byte, []int) {
	return file_MCD_SPOT_proto_rawDescGZIP(), []int{1}
}
...
var File_MCD_SPOT_proto protoreflect.FileDescriptor

var file_MCD_SPOT_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x4d, 0x43, 0x44, 0x5f, 0x53, 0x50, 0x4f, 0x54, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x08, 0x4d, 0x43, 0x44, 0x5f, 0x53, 0x50, 0x4f, 0x54, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x61, 0x74, 0x61, 0x22, 0x6a, 0x0a, 0x04, 0x50, 0x6f, 0x6b, 0x65, 0x12, 0x2a, 0x0a, 0x02, 0x74,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x49, 0x6c, 0x6b, 0x12, 0x10, 0x0a, 0x03, 0x56, 0x61, 0x6c,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x56, 0x61, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x53,
	0x70, 0x6f, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x53, 0x70, 0x6f, 0x74, 0x42,
	0x3b, 0x5a, 0x39, 0x62, 0x6c, 0x65, 0x70, 0x2e, 0x61, 0x69, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f,
	...
	0x63, 0x74, 0x73, 0x2f, 0x4d, 0x43, 0x44, 0x5f, 0x53, 0x50, 0x4f, 0x54, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_MCD_SPOT_proto_rawDescOnce sync.Once
	file_MCD_SPOT_proto_rawDescData = file_MCD_SPOT_proto_rawDesc
)

func file_MCD_SPOT_proto_rawDescGZIP() []byte {
	file_MCD_SPOT_proto_rawDescOnce.Do(func() {
		file_MCD_SPOT_proto_rawDescData = protoimpl.X.CompressGZIP(file_MCD_SPOT_proto_rawDescData)
	})
	return file_MCD_SPOT_proto_rawDescData
}

var file_MCD_SPOT_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_MCD_SPOT_proto_goTypes = []interface{}{
	(*LogNote)(nil),               // 0: MCD_SPOT.LogNote
	(*Poke)(nil),                  // 1: MCD_SPOT.Poke
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_MCD_SPOT_proto_depIdxs = []int32{
...
func init() { file_MCD_SPOT_proto_init() }
func file_MCD_SPOT_proto_init() {
	if File_MCD_SPOT_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_MCD_SPOT_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_MCD_SPOT_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Poke); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_MCD_SPOT_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_MCD_SPOT_proto_goTypes,
		DependencyIndexes: file_MCD_SPOT_proto_depIdxs,
		MessageInfos:      file_MCD_SPOT_proto_msgTypes,
	}.Build()
	File_MCD_SPOT_proto = out.File
	file_MCD_SPOT_proto_rawDesc = nil
	file_MCD_SPOT_proto_goTypes = nil
	file_MCD_SPOT_proto_depIdxs = nil
}
