...
func (x *AdminChanged) Reset() {
	*x = AdminChanged{}
	if protoimpl.UnsafeEnabled {
		mi := &file_PaxUSD_PaxUSD_proto_msgTypes[0]
...
func (*AdminChanged) Descriptor() ([]byte, []int) {
	return file_PaxUSD_PaxUSD_proto_rawDescGZIP(), []int{0}
}
...
func (x *Upgraded) Reset() {
	*x = Upgraded{}
	if protoimpl.UnsafeEnabled {
		mi := &file_PaxUSD_PaxUSD_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Upgraded) Descriptor() ([]byte, []int) {
	return file_PaxUSD_PaxUSD_proto_rawDescGZIP(), []int{1}
}
...
var file_PaxUSD_PaxUSD_proto_rawDesc = []byte{
	0x0a, 0x13, 0x50, 0x61, 0x78, 0x55, 0x53, 0x44, 0x2f, 0x50, 0x61, 0x78, 0x55, 0x53, 0x44, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x50, 0x61, 0x78, 0x55, 0x53, 0x44, 0x1a, 0x1f, 0x67,
	...
	0x2f, 0x50, 0x61, 0x78, 0x55, 0x53, 0x44, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_PaxUSD_PaxUSD_proto_rawDescOnce sync.Once
	file_PaxUSD_PaxUSD_proto_rawDescData = file_PaxUSD_PaxUSD_proto_rawDesc
)

func file_PaxUSD_PaxUSD_proto_rawDescGZIP() []byte {
	file_PaxUSD_PaxUSD_proto_rawDescOnce.Do(func() {
		file_PaxUSD_PaxUSD_proto_rawDescData = protoimpl.X.CompressGZIP(file_PaxUSD_PaxUSD_proto_rawDescData)
	})
	return file_PaxUSD_PaxUSD_proto_rawDescData
}

var file_PaxUSD_PaxUSD_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_PaxUSD_PaxUSD_proto_goTypes = []interface{}{
	(*AdminChanged)(nil),          // 0: PaxUSD.AdminChanged
	(*Upgraded)(nil),              // 1: PaxUSD.Upgraded
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_PaxUSD_PaxUSD_proto_depIdxs = []int32{
...
func init() { file_PaxUSD_PaxUSD_proto_init() }
func file_PaxUSD_PaxUSD_proto_init() {
	if File_PaxUSD_PaxUSD_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_PaxUSD_PaxUSD_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_PaxUSD_PaxUSD_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_PaxUSD_PaxUSD_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_PaxUSD_PaxUSD_proto_goTypes,
		DependencyIndexes: file_PaxUSD_PaxUSD_proto_depIdxs,
		MessageInfos:      file_PaxUSD_PaxUSD_proto_msgTypes,
	}.Build()
	File_PaxUSD_PaxUSD_proto = out.File
	file_PaxUSD_PaxUSD_proto_rawDesc = nil
	file_PaxUSD_PaxUSD_proto_goTypes = nil
	file_PaxUSD_PaxUSD_proto_depIdxs = nil
}
