...
import (
	...
	"github.com/trylotus/connectors/xo-1731686188/contracts/usercontract0"
)

var ContractList = []evm.SmartContract{
    
        usercontract0.NewContract(ethcommon.HexToAddress("0x84583e7d2d92d87d5b3bac850ab4bad37ae568e8")),
}
