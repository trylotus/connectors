...
require (
	...
	github.com/nakji-network/connector v0.0.1-beta.1.0.20221222184121-22c00cf66bd7
	github.com/nakji-network/connector/chain/ethereum v0.0.0-20221222184121-22c00cf66bd7
